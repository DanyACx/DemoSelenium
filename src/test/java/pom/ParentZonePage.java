...
public class ParentZonePage extends BasePage{

    public ParentZonePage(WebDriver driver){
        super(driver);
    }
    ...
    By opcionParentZoneLocator = By.xpath("/html/body/app-root/mge-en/mge-shell/mge-navbar-default/mge-navbar-shell/nav/div/div/ul/li[2]/a");

    By parentZoneLocator = By.xpath("/html/body/app-root/mge-en/mge-shell/main/mge-th-pages/div/mge-parent-zone-lessons/div/div/div[1]/div/div[1]/h5");
    ...
    public void hacerClickOpcionParentZone() throws Exception { // opcion "My Account"
        this.click(opcionParentZoneLocator);
        Thread.sleep(2000);
    }

    public boolean seVisualizaParentZonePage() throws Exception {
        Thread.sleep(2000);
        return this.seVisualiza(parentZoneLocator);
    }
}
